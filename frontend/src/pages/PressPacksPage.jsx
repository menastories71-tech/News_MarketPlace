          ...
          >
            ...
            <div className="max-w-4xl mx-auto mt-8 flex flex-col md:flex-row items-center gap-4">
              ...
              <div className="bg-white p-2 px-4 rounded-lg border border-[#E0E0E0] shadow-sm flex items-center gap-2 relative">
                ...
                {renderShareMenu(window.location.href, t('pressPacks.title'), 'hero')}
              </div>
            </div>
          </motion.div>
        </div>
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                          ...
                          <div className="relative" onClick={(e) => e.stopPropagation()}>
                            <button
                              onClick={() => setActiveShareId(activeShareId === pack.id ? null : pack.id)}
                              className="p-2 rounded-lg hover:bg-slate-100 text-slate-500 transition-colors"
                            >
                              <Icon name="share" size={18} />
                            </button>
                            {renderShareMenu(
                              `${window.location.origin}/press-packs/${createSlugPath(pack.name, pack.id)}`,
                              pack.name,
                              pack.id,
                              'right'
                            )}
