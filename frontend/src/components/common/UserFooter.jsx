        ...
        <div className="flex flex-col lg:flex-row lg:justify-between gap-8 mb-8">
          ...
          <div className="flex flex-col lg:max-w-xs">
            ...
            <div className="flex space-x-3">
              {socialMediaIcons.map((icon) => (
                ...
                >
                  {icon.name === 'x' ? (
                    <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 462.799" className="w-5 h-5">
          ...
          <div className="flex flex-col lg:w-64">
            ...
            <ul className="space-y-1.5">
              ...
              <li><Link to="/media-partnerships" className="body-small text-gray-600 hover:text-primary transition-colors">{mediaPartnershipsEvents}</Link></li>
